...
public final class UiStyles {
    ...
    public static void styleTable(JTable table) {
        ...
        table.setSelectionBackground(new Color(0xE8F0FF));
        table.setSelectionForeground(TEXT_PRIMARY);
        table.setOpaque(true);
        table.setFillsViewportHeight(true);
        table.setDefaultRenderer(Object.class, new LightTableCellRenderer());
        ...
        if (header != null) {
            ...
            header.setDefaultRenderer(new LightTableHeaderRenderer());
        }
    }
    ...
    private static final class LightTableHeaderRenderer extends DefaultTableCellRenderer {

        LightTableHeaderRenderer() {
            setOpaque(true);
    ...
    private static final class LightTableCellRenderer extends DefaultTableCellRenderer {

        LightTableCellRenderer() {
            setOpaque(true);
        ...
        public Component getTableCellRendererComponent(
            ...
            setBackground(isSelected ? new Color(0xE8F0FF) : WHITE);
            setForeground(TEXT_PRIMARY);
            setText(value != null ? value.toString() : "");
            return this;
        }
